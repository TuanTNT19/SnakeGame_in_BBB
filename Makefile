...
INC_FLAG := -I $(INC_DIR)
LIB_NAME := snake_game_keyboard
mk_objs_sta:
	$(CC) -c $(SRC_DIR)/ssd1306.c -o $(OBJ_DIR)/ssd1306.o $(INC_FLAG)
	$(CC) -c $(SRC_DIR)/getkeyboard.c -o $(OBJ_DIR)/getkeyboard.o $(INC_FLAG)
...
mk_objs_share:
	...
	$(CC) -c -fPIC $(SRC_DIR)/getkeyboard.c -o $(OBJ_DIR)/getkeyboard.o $(INC_FLAG)
mk_static:
	ar src $(STA_DIR)/lib$(LIB_NAME).a $(OBJ_DIR)/getkeyboard.o $(OBJ_DIR)/ssd1306.o $(OBJ_DIR)/snake.o
mk_share:
	$(CC) -shared $(OBJ_DIR)/getkeyboard.o $(OBJ_DIR)/snake.o $(OBJ_DIR)/ssd1306.o -o $(SHARE_DIR)/lib$(LIB_NAME).so
install:
